...
{
  InitializeShader(device, window, L"../CobaltBlueEngine/Shaders/color.vs", L"../CobaltBlueEngine/Shaders/color.ps");
}
...
void ShaderCore::InitializeShader(ID3D11Device* device, HWND window, WCHAR* vertexShader, WCHAR* pixelShader)
{
  HRESULT result;
